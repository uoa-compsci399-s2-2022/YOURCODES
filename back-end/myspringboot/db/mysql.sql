...
CREATE TABLE `problemdetaile` (
  ...
  `description` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1584162423803944963 DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `tb_problem` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1666528728794 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_problem` VALUES (1664874086967,'1. Two Sum',4,'Easy',5,4.500,'1;2;4;','Algorithms','admin'),(1664875309355,'9. Palindrome Number',2,'Medium',0,4.000,'1;3;7;','Algorithms','admin'),(1664875441891,'11. Container With Most Water',2,'Easy',0,0.000,'1;3;7;','Algorithms','admin'),(1664881882230,'4. Median of Two Sorted Arrays',0,'Hard',3,4.500,'1;2;7;14;','Mathematics','admin'),(1664884129817,'20. Valid Parentheses',1,'Easy',0,0.000,'1;2;3;','Mathematics','tom'),(1664953253265,'15. 3Sum',0,'Medium',0,0.000,'5;8;','Algorithms','admin'),(1664954333371,'24. Swap Nodes in Pairs',0,'Medium',0,0.000,'6;8;','Algorithms','admin'),(1666526644079,'29. Divide Two Integers',2,'',1,3.500,'','','admin'),(1666526912174,'12.reverse',NULL,'Easy',1,3.000,'8;','Algorithms','admin'),(1666527657877,'2.123',NULL,'Easy',0,0.000,'7;8;15;','Algorithms','admin'),(1666528420198,'22252',NULL,'Medium',0,0.000,'8;9;','Databases','admin'),(1666528607057,'sadad',NULL,'Medium',0,0.000,'9;17;','Databases','admin'),(1666528728793,'asdas',NULL,'',0,0.000,'','','admin');
...
INSERT INTO `tb_score` VALUES (8,1664874086967,'admin',5),(9,1664875309355,'admin',4),(10,1664881882230,'admin',4),(11,1664881882230,'tom',5),(12,1664874086967,'jack',4),(13,1666526644079,'admin',4),(14,1666526644079,'tom',3),(15,1666526912174,'tom',3);
...
INSERT INTO `tb_user` VALUES (1,'tom','123','123456@qq.com','123456','2 Year','hi, i like java.'),(2,'admin','admin1','1454486789@qq.com','13207178147','beijing','my name is adminadmin'),(12,'admin1','1444','1454486723@qq.com',NULL,NULL,NULL),(13,'jack','123456','123','123','man','qweda'),(14,'小煞笔','123456789','大傻逼',NULL,NULL,NULL);
...
-- Dump completed on 2022-10-24 22:06:49
